...
public class PayService {
	...
	public static  Map<String,String> weixinpay(Map<String,String> pa) {
		...
		String wx_native_app_id =pa.get("wx_native_app_id"); // 微信应用id
		String wx_native_mch_id =pa.get("wx_native_mch_id"); // 微信商户id
		String wx_native_key =pa.get("wx_native_key"); // 微信秘钥
		String wxPayUrl = pa.get("wxPayUrl"); // 预付单地址
