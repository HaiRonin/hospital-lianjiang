    ...
    <div class="list-block" style="margin: 0;font-size: 14px;">
        <ul>
            ...
            <li class="item-content" style="padding-left: 0;min-height: auto;height: 35px;line-height: 35px">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner">
                    <div class="item-title" >住院流水号：</span></div>
                    <div id="inHosSerialNo" class="item-after"></div>
                </div>
            </li>
            <li class="item-content" style="padding-left: 0;min-height: auto;height: 35px;line-height: 35px">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner">
                    <div class="item-title" >医保类型代码：</span></div>
            ...
            <li class="item-content" style="padding-left: 0;min-height: auto;height: 35px;line-height: 35px">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner">
                    <div class="item-title" >医保类型名称：</span></div>
                ...
                if (result != null) {
                    if (result.resultCode === "00") {
                        if (result.inHosList !== null) {
                            ...
                            $('#inHosSerialNo').text(result.inHosSerialNo);
                            $('#medicalTypeCode').text(result.medicalTypeCode);
                            $('#medicalTypeNmae').text(result.medicalTypeNmae );
