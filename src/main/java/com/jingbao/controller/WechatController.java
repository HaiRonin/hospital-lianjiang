            ...
            if(orderNo==null){
                ...
                if(orderNo.substring(0,2).equals("RE")){
                    ...
                    if (isOK){
                        ...
                        Map<String, Object> info = iWechatService.refund(wpr.getTransaction_id(),String.valueOf(doregInfoNew.getPayAmount()));
...
//                            DopayInfo dopayInfoNew = dopayInfoService.selectOne(wntityWrapper);
                    ...
                    if (getIsOK){
                        ...
                        Map<String, Object> info = iWechatService.refund(wpr.getTransaction_id(),String.valueOf(depositPayment.getPayMoney()));
                        if(info.get("code").equals("SUCCESS")){
