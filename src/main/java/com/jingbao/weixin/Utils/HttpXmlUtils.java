...
import com.jingbao.weixin.entity.RefundVo;
...
public class HttpXmlUtils {
     ...
     * @return
     */
    public static String xmlInfoJs(RefundVo unifiedorder) {
        if (unifiedorder != null) {
            StringBuffer bf = new StringBuffer();
            bf.append("<xml>");
            ...
            bf.append(unifiedorder.getOut_refund_no());
            ...
            bf.append(unifiedorder.getRefund_fee());
     ...
     * @return
     */
    public static String xmlInfoJs(Unifiedorder unifiedorder) {
        //构造xml参数的时候，至少又是个必传参数
		/*
		 * <xml>
			   <appid>wx2421b1c4370ec43b</appid>
